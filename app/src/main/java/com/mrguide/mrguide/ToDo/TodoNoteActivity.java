package com.mrguide.mrguide.ToDo;
...
public class TodoNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inDesc.setMaxLines(5);
        inDesc.setScroller(new Scroller(getApplicationContext()));
        inDesc.setMovementMethod(new ScrollingMovementMethod());
            ...
            public void onClick(View v) {
                if (isNewTodo) {
                    ...
                    if(inTitle.getText().toString().isEmpty()){
                        inTitle.setError("Enter Title");
                        return;
                    }
                    if(inDesc.getText().toString().isEmpty()){
                        inDesc.setError("Enter Description");
                        return;
                    }
        ...
        //For Action Bar
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color='#ffffff'> TODO </font>"));
    }
